...
type Config struct {
	...
	OTSEsploraURL             string
	OTSEsploraTimeoutSeconds  int
	OTSUpgradeIntervalSeconds int64
	SMTPHost                  string
	SMTPPort                  int
	SMTPUser                  string
	SMTPPass                  string
...
func Load() *Config {
	...
	cfg := &Config{
		...
		OTSEsploraURL:             getEnv("OTS_ESPLORA_URL", ""),
		OTSEsploraTimeoutSeconds:  int(getEnvInt("OTS_ESPLORA_TIMEOUT_SECONDS", 10)),
		OTSUpgradeIntervalSeconds: getEnvInt("OTS_UPGRADE_INTERVAL_SECONDS", 21_600),
